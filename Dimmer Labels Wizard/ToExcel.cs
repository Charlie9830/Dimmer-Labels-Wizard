...
namespace Dimmer_Labels_Wizard
{
    public class ToExcel
    {
        ...
        {
            ToExcel.Output_Application = new Excel.Application();
            //FileOut.Output_Application.Visible = false;
            ToExcel.Output_Workbook = Output_Application.Workbooks.Open(@"C:\Users\Charlie Samsung\SkyDrive\C# Projects\Dimmer Labels Wizard\Test Output Files\Test Output.xlsx");
            ToExcel.Output_Worksheet = Output_Workbook.Sheets[1];
        }
        ...
        public static void DebugDimDistroUnitsToExcel()
        {
            // Init Excel Object
            ToExcel.InitExcel();
